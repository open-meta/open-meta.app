...
F6  = tibble(Name="groupNUM",   Type="MEDIUMINT", Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F7  = tibble(Name="name",       Type="VARCHAR",   Size="254", NoSign="F", NoNull="T", Default="s",       Key="")
F8  = tibble(Name="value",      Type="TEXT",      Size="",    NoSign="",  NoNull="T" ,Default="x",       Key="")
...
extract=rbind(F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,F11,F12,F13,F14,F15)
