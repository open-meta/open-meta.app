...
F16 = tibble(Name="updateID",   Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F17 = tibble(Name="updateOfID", Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F18 = tibble(Name="fileName",   Type="VARCHAR",   Size="254", NoSign="",  NoNull="",  Default="s",       Key="")
