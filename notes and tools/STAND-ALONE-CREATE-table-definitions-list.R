...
F12 = tibble(Name="citeLevel",  Type="TINYINT",   Size="",    NoSign="T", NoNull="T", Default="z",       Key="")
F13 = tibble(Name="citesL1",    Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F14 = tibble(Name="citesL2",    Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F15 = tibble(Name="createDate", Type="VARCHAR",   Size="23",  NoSign="",  NoNull="T", Default="s",       Key="")
F16 = tibble(Name="procDate",   Type="VARCHAR",   Size="23",  NoSign="",  NoNull="",  Default="s",       Key="")
F17 = tibble(Name="updateDate", Type="VARCHAR",   Size="23",  NoSign="",  NoNull="",  Default="s",       Key="")
F18 = tibble(Name="updateID",   Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F19 = tibble(Name="updateOfID", Type="SMALLINT",  Size="",    NoSign="T", NoNull="",  Default="z",       Key="")
F20 = tibble(Name="fileName",   Type="VARCHAR",   Size="254", NoSign="",  NoNull="",  Default="s",       Key="")
F21 = tibble(Name="fileSize",   Type="INT",       Size="",    NoSign="T", NoNull="T", Default="z",       Key="")
F22 = tibble(Name="fileType",   Type="VARCHAR",   Size="40",  NoSign="",  NoNull="T", Default="s",       Key="")
F23 = tibble(Name="fileTime",   Type="VARCHAR",   Size="23",  NoSign="",  NoNull="T", Default="s",       Key="")
F24 = tibble(Name="fileRaw",    Type="LONGTEXT",  Size="",    NoSign="",  NoNull="",  Default="x",       Key="")
...
rm(F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,F11,F12,F13,F14,F15,F16,F17,F18,F19,F20,F21,F22,F23,F24,F25,F26,F27,F28,F29,F30)
